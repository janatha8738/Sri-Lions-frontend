...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Contact Bar - Maroon gradient design */}
      <div className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-[#4a0e0e] via-[#5c1111] to-[#4a0e0e] border-b border-red-900/40 shadow-xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-6 text-sm">
            <a href="mailto:info@sri-lions.com" className="flex items-center gap-2 text-gray-200 hover:text-yellow-400 transition-colors">
            ...
            <a href="#" className="flex items-center gap-2 text-gray-200 hover:text-yellow-400 transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
      ...
      {/* Main Navigation - Maroon theme */}
      <nav
        className={`fixed left-0 w-full z-40 backdrop-blur-md transition-all duration-300 shadow-2xl ${
          isScrolled ? "top-[48px] bg-gradient-to-r from-[#1a0606]/98 via-[#2d0a0a]/98 to-[#1a0606]/98 border-b border-yellow-600/30" : "top-[48px] bg-gradient-to-r from-[#1a0606]/95 via-[#2d0a0a]/95 to-[#1a0606]/95 border-b border-red-900/40"
        }`}
      >
